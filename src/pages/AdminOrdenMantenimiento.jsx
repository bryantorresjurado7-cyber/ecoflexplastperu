        ...
        <div className="p-6 md:p-8 space-y-8 bg-fondo-claro min-h-screen">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                ...
                <div className="flex gap-3">
                    ...
                    <button type="button" className="flex items-center gap-2 px-4 py-2 border border-gray-300 rounded-lg bg-white hover:bg-gray-50 text-gris-oscuro">
                        <Printer size={18} />
                        <span>Imprimir</span>
                    </button>
                    {!isViewMode && (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="bg-gray-50 p-4 rounded-lg h-fit">
                                ...
                                <div className="space-y-3">
                                    <input type="text" placeholder="Nombre completo" className="w-full bg-white border border-gray-200 rounded px-3 py-2 text-sm" />
                                    <input type="text" placeholder="Cargo" className="w-full bg-white border border-gray-200 rounded px-3 py-2 text-sm" />
                                    <input type="text" placeholder="Contacto / Anexo" className="w-full bg-white border border-gray-200 rounded px-3 py-2 text-sm" />
                                </div>
                            </div>
                        </div>
                    </section>
                    ...
                    <section className="bg-white p-6 rounded-xl shadow-card border-l-4 border-l-orange-500">
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm" placeholder="Ej. Turno Noche (22:00 - 06:00)" />
                            </div>
